...
if __name__ == "__main__":
    ...
    #     verbose=True
    # )
    results = deep_causal_research(labeled_data='labeled5mEE.pkl', max_time_minutes=120)
...
# C:\Users\themi\PycharmProjects\Seagull2\.venv\Scripts\python.exe C:\Users\themi\PycharmProjects\Seagull2\causation_agentic_research_2.py
# Causal Financial Research System
# ==================================================
#
# 🚀 Running Quick Causal Research...
# Label distributions:
# CUSUM_event_label: CUSUM_event_label
# CUSUM_event_label
# 0.0    370940
# 1.0    224086
# Name: count, dtype: int64
# vpd_volatility_event_label: vpd_volatility_event_label
# vpd_volatility_event_label
# 1.0    588987
# 0.0      6039
# Name: count, dtype: int64
# outlier_event_label: outlier_event_label
# outlier_event_label
# 0.0    382243
# 1.0    212783
# Name: count, dtype: int64
# momentum_regime_event_label: momentum_regime_event_label
# momentum_regime_event_label
# 0.0    380024
# 1.0    215002
# Name: count, dtype: int64
# traditional_event_label: traditional_event_label
# traditional_event_label
# 0.0    380545
# 1.0    214481
# Name: count, dtype: int64
# any_event_label: any_event_label
# any_event_label
# 0.0    382047
# 1.0    212979
# Name: count, dtype: int64
# covent_2way_CUSUM_BB_upper_cross_label: covent_2way_CUSUM_BB_upper_cross_label
# covent_2way_CUSUM_BB_upper_cross_label
# 0.0    338678
# 1.0    256348
# Name: count, dtype: int64
# covent_2way_CUSUM_BB_lower_cross_label: covent_2way_CUSUM_BB_lower_cross_label
# covent_2way_CUSUM_BB_lower_cross_label
# 0.0    365760
# 1.0    229266
# Name: count, dtype: int64
# covent_2way_vpd_volatility_momentum_regime_label: covent_2way_vpd_volatility_momentum_regime_label
# covent_2way_vpd_volatility_momentum_regime_label
# 0.0    591444
# 1.0      3582
# Name: count, dtype: int64
# covent_2way_outlier_BB_expansion_label: covent_2way_outlier_BB_expansion_label
# covent_2way_outlier_BB_expansion_label
# 0.0    389544
# 1.0    205482
# Name: count, dtype: int64
# covent_2way_momentum_regime_BB_squeeze_label: covent_2way_momentum_regime_BB_squeeze_label
# covent_2way_momentum_regime_BB_squeeze_label
# 0.0    371464
# 1.0    223562
# Name: count, dtype: int64
# any_2way_covent_label: any_2way_covent_label
# any_2way_covent_label
# 0.0    381803
# 1.0    213223
# Name: count, dtype: int64
# count_2way_covent_label: count_2way_covent_label
# count_2way_covent_label
# 0.0    381763
# 1.0    213263
# Name: count, dtype: int64
# covent_3way_CUSUM_vpd_volatility_momentum_regime_label: covent_3way_CUSUM_vpd_volatility_momentum_regime_label
# covent_3way_CUSUM_vpd_volatility_momentum_regime_label
# 1.0    587174
# 0.0      7852
# Name: count, dtype: int64
# covent_3way_BB_upper_cross_outlier_momentum_regime_label: covent_3way_BB_upper_cross_outlier_momentum_regime_label
# covent_3way_BB_upper_cross_outlier_momentum_regime_label
# 0.0    359721
# 1.0    235305
# Name: count, dtype: int64
# covent_3way_vpd_volatility_outlier_momentum_regime_label: covent_3way_vpd_volatility_outlier_momentum_regime_label
# covent_3way_vpd_volatility_outlier_momentum_regime_label
# 1.0    588671
# 0.0      6355
# Name: count, dtype: int64
# any_3way_covent_label: any_3way_covent_label
# any_3way_covent_label
# 0.0    363047
# 1.0    231979
# Name: count, dtype: int64
# count_3way_covent_label: count_3way_covent_label
# count_3way_covent_label
# 0.0    363470
# 1.0    231556
# Name: count, dtype: int64
# any_covent_label: any_covent_label
# any_covent_label
# 0.0    381803
# 1.0    213223
# Name: count, dtype: int64
# total_covent_count_label: total_covent_count_label
# total_covent_count_label
# 0.0    381026
# 1.0    214000
# Name: count, dtype: int64
# covent_intensity_label: covent_intensity_label
# covent_intensity_label
# 0.0    381026
# 1.0    214000
# Name: count, dtype: int64
# high_intensity_covent_label: high_intensity_covent_label
# high_intensity_covent_label
# 0.0    399029
# 1.0    195997
# Name: count, dtype: int64
# very_high_intensity_covent_label: very_high_intensity_covent_label
# very_high_intensity_covent_label
# 0.0    406344
# 1.0    188682
# Name: count, dtype: int64
# covent_persistence_label: covent_persistence_label
# covent_persistence_label
# 0.0    382823
# 1.0    212203
# Name: count, dtype: int64
# sustained_covent_label: sustained_covent_label
# sustained_covent_label
# 0.0    382064
# 1.0    212962
# Name: count, dtype: int64
# individual_event_count_label: individual_event_count_label
# individual_event_count_label
# 0.0    381660
# 1.0    213366
# Name: count, dtype: int64
#
...
# Features: 172
# Features with NaN: 0
# Critical data diagnostics:
# 1. Data shape: (595026, 254)
# 2. Date range: 2020-01-03 08:00:00 to 2025-08-31 23:55:00
# 3. Label event rates:
#    CUSUM_event_label: 37.660%
#    vpd_volatility_event_label: 98.985%
#    outlier_event_label: 35.760%
#    momentum_regime_event_label: 36.133%
#    traditional_event_label: 36.046%
#    any_event_label: 35.793%
#    covent_2way_CUSUM_BB_upper_cross_label: 43.082%
#    covent_2way_CUSUM_BB_lower_cross_label: 38.530%
#    covent_2way_vpd_volatility_momentum_regime_label: 0.602%
#    covent_2way_outlier_BB_expansion_label: 34.533%
#    covent_2way_momentum_regime_BB_squeeze_label: 37.572%
#    any_2way_covent_label: 35.834%
#    count_2way_covent_label: 35.841%
#    covent_3way_CUSUM_vpd_volatility_momentum_regime_label: 98.680%
#    covent_3way_BB_upper_cross_outlier_momentum_regime_label: 39.545%
#    covent_3way_vpd_volatility_outlier_momentum_regime_label: 98.932%
#    any_3way_covent_label: 38.986%
#    count_3way_covent_label: 38.915%
#    any_covent_label: 35.834%
#    total_covent_count_label: 35.965%
#    covent_intensity_label: 35.965%
#    high_intensity_covent_label: 32.939%
#    very_high_intensity_covent_label: 31.710%
#    covent_persistence_label: 35.663%
#    sustained_covent_label: 35.790%
#    individual_event_count_label: 35.858%
# 4. Feature completeness:
#    Average feature completeness: 100.0%
# 2025-09-16 12:40:54,810 - CAUSAL_AGENT - INFO - Data cleaned for causality: (595026, 254)
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO - Remaining NaN values: 0
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO - Causal Financial Research Agent initialized
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO - Detected 26 event types
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO - Available features: 89
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO -
# 🚀 COMPREHENSIVE CAUSAL RESEARCH
# 2025-09-16 12:40:55,631 - CAUSAL_AGENT - INFO - ======================================================================
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO - Time budget: 30 minutes
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO - Events to research: 26
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO -
# [1/26] Researching: CUSUM_event_label
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO - ⏱️  Remaining time: 30.0 minutes
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO -
# 🔬 CAUSAL RESEARCH: CUSUM_event_label
# 2025-09-16 12:40:55,632 - CAUSAL_AGENT - INFO - ============================================================
# 2025-09-16 12:40:58,841 - CAUSAL_AGENT - INFO - 📊 Data prepared: 595026 samples, 89 features
# 2025-09-16 12:40:58,841 - CAUSAL_AGENT - INFO - 💡 Generated 4 economic hypotheses
# 2025-09-16 12:40:58,841 - CAUSAL_AGENT - INFO -    • Past positive returns cause future positive returns through herding behavior
# 2025-09-16 12:40:58,841 - CAUSAL_AGENT - INFO -    • High volatility causes future high volatility through information arrival
# 2025-09-16 12:40:58,841 - CAUSAL_AGENT - INFO -    • Large price deviations cause reversions to fundamental value
# 2025-09-16 12:40:58,842 - CAUSAL_AGENT - INFO - 🔍 Discovering causal relationships...
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO - ✅ Discovered 15 causal relationships
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO -    • Open → CUSUM_event_label
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO -      Mechanism: information_asymmetry, Strength: 1.000
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO -    • High → CUSUM_event_label
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO -      Mechanism: information_asymmetry, Strength: 1.000
# 2025-09-16 16:55:12,148 - CAUSAL_AGENT - INFO -    • Low → CUSUM_event_label
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO -      Mechanism: information_asymmetry, Strength: 1.000
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO -    • Close → CUSUM_event_label
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO -      Mechanism: information_asymmetry, Strength: 1.000
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO -    • Volume → CUSUM_event_label
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO -      Mechanism: information_asymmetry, Strength: 1.000
# 2025-09-16 16:55:12,149 - CAUSAL_AGENT - INFO - 💰 Validating economic performance...
# 2025-09-16 16:55:18,423 - CAUSAL_AGENT - INFO - 🏆 15 relationships passed economic validation
# 2025-09-16 16:55:18,423 - CAUSAL_AGENT - INFO - 🥇 Best: MACD → CUSUM_event_label
# 2025-09-16 16:55:18,423 - CAUSAL_AGENT - INFO -    Return: 18.3133, Sharpe: 0.821
#
# ================================================================================
# 🔬 CAUSAL FINANCIAL RESEARCH SUMMARY
# ================================================================================
# 📊 Research Statistics:
#    • Events attempted: 26
#    • Successful research: 1
#    • Success rate: 3.8%
#    • Duration: 254.4 minutes
#
# 🧠 Causal Knowledge Base:
#    • Total causal relationships: 15
#    • Economic insights generated: 1
#    • Failed relationships avoided: 0
#
# 🔍 Causal Analysis:
#    • Relationships discovered: 15
...
#
# 🔬 For Deep Causal Research, use:
# results = deep_causal_research(labeled_data='your_data.pkl', max_time_minutes=120)
#
# 🎯 For Focused Causal Research, use:
# results = focused_causal_research(
#     labeled_data='your_data.pkl',
#     target_events=['momentum_label', 'volatility_label'],
#     min_causal_strength=0.5
# )
#
# ✅ For Causal Relationship Validation, use:
# results = validate_causal_stability(
#     labeled_data='new_data.pkl',
#     causal_relationships_file='causal_knowledge_base.pkl'
# )
# 2025-09-16 16:55:18,461 - CAUSAL_AGENT - INFO - ⏰ Time budget nearly exhausted. Stopping research.
# 2025-09-16 16:55:18,473 - CAUSAL_AGENT - INFO - 💾 Causal research results saved to causal_results
#
# 🔬 For Deep Causal Research, use:
# results = deep_causal_research(labeled_data='your_data.pkl', max_time_minutes=120)
#
